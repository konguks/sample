...
require_once getcwd() . '/phpInsight/autoload.php';
...
class NewWorld
{
    ...
    public function GetAPICon(){
        ...
        $CONSUMER_KEY = 'tEOWFrYWgs4ml0PzJtKSsYUrj';
        #define('CONSUMER_SECRET', 'o58Tp63xUnNkIJUIr9o96O47kwhvNq1amRciv5F5MtdTLPwX1z');
        $CONSUMER_SECRET = 'o58Tp63xUnNkIJUIr9o96O47kwhvNq1amRciv5F5MtdTLPwX1z';
        #define('ACCESS_TOKEN', '714419437-qTbbCQGAq3fx3Hn6RDpv7MZ6CA78BLwDxWlMAY7O');
        $ACCESS_TOKEN = '714419437-qTbbCQGAq3fx3Hn6RDpv7MZ6CA78BLwDxWlMAY7O';
        #define('ACCESS_TOKEN_SECRET', 'bX6sQfSD9MNKez83VAjKWOq7bxWc8DVxsOmTgTOjXuxwi');
        $ACCESS_TOKEN_SECRET = 'bX6sQfSD9MNKez83VAjKWOq7bxWc8DVxsOmTgTOjXuxwi';
